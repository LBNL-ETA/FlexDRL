...
BESTMODEL = "testingtrials/trporun1/best_-726723.486_1751950.dat"#"saves/d4pg-Test6/best_-49936.050_2452730.dat" #best_-4488.278_700780.dat" #best_-124.831_1751950.dat"
...
def pred_net(net, env, device="cpu"):
    ...
    actions_df.to_csv('preds/actions_df_trpo1_multienv_003.csv',index=False)
    obs_df.to_csv('preds/obs_df_trpo1_multienv_003.csv',index=False)
    reward_df.to_csv('preds/reward_df_trpo1_multienv_003.csv',index=False)
    e_costs_df.to_csv('preds/e_costs_df_trpo1_multienv_003.csv',index=False)
...
if __name__ == "__main__":
    ...
    env = flexlab_env.FlexLabEnv(envelope_path = 'fmu_models/FlexlabXR_v1_SFO_2017.fmu',
                                 battery_path = 'fmu_models/battery.fmu',
                                 pv_path =  'fmu_models/PV_SFO_2017.fmu', 
