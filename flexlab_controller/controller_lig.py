...
class FlexlabController:
    ...
    def __init__(
        ...
        self.action_names = ["SaFrB", "SaTempB", "LigB_input", "P_ctrl"]
        self.action_init = np.array([0.5, 21.5, 1.0, 0.0])
        self.action_space_low = np.array([0.05, 10.0, 0.0, -3300.0])
        self.action_space_high = np.array([2.0, 30.0, 1.0, 3300.0])
    ...
    def predict_action(self, now_t,device="cpu"):
        ...
        action_dict = {
            ...
            'light_level_sp': [action_rescaled[self.action_names.index("LigB_input")]],
    ...
    def _eprice_ahead(self, hours_ahead, now_t):
        ...
        return np.array(eprice_ahead.iloc[0:hours_ahead,])
